		...
		<div className='row my-5' id='experience'>
			...
			<div className=''>
				<ExperienceComponent
					...
					desc={[
						'mplemented custom calendar for scheduling slots which will remove the unnecessary crowd at the warehouses by 90% and help control the number of employees at warehouses.',
				...
				<ExperienceComponent
					...
					desc={[
						...
						'mplemented UI based feature to make application more interactive which increased customer base by 10%.',
